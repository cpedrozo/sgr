...
CREATE SEQUENCE sgr.flujo_id_flujo_seq;

CREATE TABLE sgr.flujo (
                id_flujo BIGINT NOT NULL DEFAULT nextval('sgr.flujo_id_flujo_seq'),
                id_estadoorigen BIGINT NOT NULL,
                id_estadodestino BIGINT NOT NULL,
                orden INTEGER,
                id_workflow BIGINT NOT NULL,
                CONSTRAINT flujo_pk PRIMARY KEY (id_flujo)
);
COMMENT ON TABLE sgr.flujo IS 'Pasos';


ALTER SEQUENCE sgr.flujo_id_flujo_seq OWNED BY sgr.flujo.id_flujo;
...
CREATE TABLE sgr.requisitos (
                ...
                orden INTEGER,
                archivo BYTEA,
                CONSTRAINT requisitos_pk PRIMARY KEY (id_requisitos)
);
...
CREATE TABLE sgr.registro (
                ...
                nombre VARCHAR(100) NOT NULL,
                observacion VARCHAR(350),
                id_persona_rtte BIGINT NOT NULL,
                id_persona_dest BIGINT NOT NULL,
                archivo BYTEA,
...
CREATE TABLE sgr.requisitos_registro (
                ...
                CONSTRAINT requisitos_registro_pk PRIMARY KEY (id_registro, id_requisitos)
);
...
ALTER TABLE sgr.registro ADD CONSTRAINT persona_registro_fk
FOREIGN KEY (id_persona_rtte)
REFERENCES sgr.persona (id_persona)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;

ALTER TABLE sgr.registro ADD CONSTRAINT persona_registro_fk1
FOREIGN KEY (id_persona_dest)
REFERENCES sgr.persona (id_persona)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
...
REFERENCES sgr.flujo (id_flujo)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;

ALTER TABLE sgr.requisitos_registro ADD CONSTRAINT requisitos_requisitos_eventos_fk
FOREIGN KEY (id_requisitos)
REFERENCES sgr.requisitos (id_requisitos)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
